...
We thank ISCRA for access to the LEONARDO supercomputer, owned by the EuroHPC Joint Undertaking, hosted by CINECA (Italy). Alexandros Delitzas is supported by the Max Planck ETH Center for Learning Systems (CLS).  Francis Engelmann is supported by an SNSF PostDoc Mobility Fellowship. Guofeng Mei is supported by PNRR FAIR - Future AI Research (PE00000013).
